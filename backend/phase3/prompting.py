...
def build_user_prompt(prefs: UserPreferences, candidates: List[Dict[str, Any]]) -> str:
    payload = {
        ...
        "instructions": (
            ...
            "For each restaurant, provide a short 'summary' strictly following this 3-bullet point format:\n"
            "🍽 Highlights\n"
            "• 🔥 Famous for: <signature dish or cuisine>\n"
            "• 🎭 Ambience: <family friendly / rooftop / casual etc>\n"
            "• 💡 Why visit: <unique factor>\n"
            "STRICT RULES: "
            "1. Do NOT generate long paragraphs. "
            "2. Maximum 3 bullet points only. "
            "3. Do NOT mention the location/city name in the summary. "
            "4. Be creative and mouth-watering with your descriptions. "
